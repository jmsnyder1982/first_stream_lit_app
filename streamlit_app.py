...
#get status response of fruityvice call
...
#displays the normalized version in a dataframe
...
#get status response of add my fruit call
add_my_fruit_response = requests.get('https://fruityvice.com/api/fruit/' + add_my_fruit)
streamlit.write('Thanks for adding', add_my_fruit_response)
